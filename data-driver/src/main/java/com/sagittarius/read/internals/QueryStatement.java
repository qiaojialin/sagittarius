...
public class QueryStatement {
    ...
    public static final String POINT_AFTER_SHIFT_QUERY_STATEMENT = "select * from %s where host='%s' and metric='%s' and time_slice='%s' and primary_time>=%d order by metric ASC, primary_time ASC limit 1";
