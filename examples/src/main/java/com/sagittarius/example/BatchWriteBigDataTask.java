...
// */
//public class BatchWriteBigDataTask extends Thread {
...
//
//    public BatchWriteBigDataTask(SagittariusWriter writer, int order, int batchSize, List<String> metrics, HashMap<String, ArrayList<Tuple22<FloatPoint,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,Float,String,Float,Float,Float,Float>>> map){
//        this.writer = writer;
//        this.order = order;
